        ...
        if(isset($_POST["numeroLote"])){
            ...
            if($resultado_1 != null)
                foreach($resultado_1 as $linha_1) {
                    ...
                    $dataAdmissaoTec = date("d/m/Y",strtotime($linha_1['dataAdmissao']));
                    if($linha_1['dataRecisao'] != null){
                        $dataRecisaoTec = date("d/m/Y",strtotime($linha_1['dataRecisao']));
                    }else{
            ...
            $retorno = '<div class="w3-row-padding" style="margin:0 -16px;">
                            <div class="w3-half">
                                <!-- <button type = "button" onclick="document.getElementById("modalVisualizaExp").style.display="none"" class="w3-button w3-block w3-gray w3-section w3-padding w3-text-white"><b>Cancelar</b></button> -->
                            </div>
                            <div class="w3-quarter w3-margin-bottom">
                                <a class="w3-button w3-block w3-teal w3-section w3-padding" href="gerarPDF.php?numeroLote='.$numeroLote.'"><b><i class="fa fa-print w3-large w3-margin-right"></i>Imprimir</b></a>
                            </div>
                        </div>';
            ...
            $retorno .= '<div class="w3-row-padding" style="margin:0 -16px;">
                            <div class="w3-half">
                                ...
                                <input class="w3-input w3-border w3-margin-bottom" type="text"
                                    placeholder="Entre com o número do lote" name="inputLote" value = "'.$numeroLote.'" readonly required>
                            </div>
                            <div class="w3-half">
                            ...
                            <div class="w3-half">
                                <label><b>Data do experimento</b></label>
                                    <input class="w3-input w3-border  w3-margin-bottom" type="date" placeholder="Data do experimento"
                                        name="dataExperimento" value = "'.$dataExperimento.'" readonly required>
                            </div>
                            <div class="w3-half">
                                <label><b>Data de validade</b></label>
                                    <input class="w3-input w3-border  w3-margin-bottom" type="date" placeholder="validade do experimento"
                                        name="dataValidadeExperimento" value = "'.$dataValidadeExperimento.'" readonly required>
                            </div>
                        </div>';
            $retorno .= '<div class="w3-row-padding" style="margin:0 -16px;">
                            <div class="w3-half w3-margin-bottom">
                                <label><b>Peso</b></label>
                                    <input class="w3-input w3-border w3-margin-bottom" type="number" min="0" step="0.01"
                                        placeholder="Peso em quilogramas (Kg)" name="pesoAmostra" value = "'.$peso.'" readonly required>

                            </div>
                            <div class="w3-half">
                                <label><b>Vomule</b></label>
                                <input class="w3-input w3-border w3-margin-bottom" type="number" min="0" step="0.01"
                                    placeholder="Volume em metros cúbicos (m³)" name="volumeAmostra" value = "'.$volume.'" readonly required>
                            </div>
                        </div>';
            $retorno .= '<div class="w3-row-padding" style="margin:0 -16px;">
                            <div class="w3-half w3-margin-bottom">
                                ...
                                <input class="w3-input w3-border w3-margin-bottom" type="number"  min="0"  max="10" step="0.1"
                                    placeholder="Valor do PH" name="phAmostra" value = "'.$ph.'" readonly required>

                            </div>
                            <div class="w3-half">
                                <label><b>Temperatura</b></label>
                                    <input class="w3-input w3-border w3-margin-bottom" type="number" step="0.1"
                                        placeholder="Temperatura (°C)" name="temperaturaAmostra" value = "'.$temperatura.'" readonly required>
                            </div>
                        </div>';
            if($salmoura){
                $retorno .= '<div class="w3-row-padding" style="margin:0 -16px;">
                                <div class="w3-half w3-margin-bottom">
                                    <input class="w3-check" name="smAmostra" type="checkbox" checked disabled>
                ...
                $retorno .= '<div class="w3-row-padding" style="margin:0 -16px;">
                                <div class="w3-half w3-margin-bottom">
                                    <input class="w3-check" name="smAmostra" type="checkbox" disabled>
                                    <label><b>Presença de Salmoura</b></label>
                                </div>
                                <div class="w3-half">
                                </div>
            ...
            $retorno .= '<div class="w3-row-padding" style="margin:0 -16px;">
                            <div class="w3-half">
                                <label><b>Condição do experimento</b></label>
                                    <select class="w3-select w3-border w3-margin-bottom" name="condicaoExp" disabled>
            ...
            $retorno .= '<div class="w3-row-padding" style="margin:0 -8px;">
                            ...
                            <textarea class="w3-input w3-border w3-margin-bottom" disabled
