...
class Administradores implements IModel
{
    public $matricula;
    public $cargo;
    public $dataadmissao;
    public $datarecisao;
    public $statusadministrador;
    public $cpf;
    public $pessoas;
    public $_col;
    ...
    public function __construct($pdo, $data = null)
    {
            ...
            array(
                ...
                array (
                    ...
                    array (
                      ...
                      'tableModelName' => 'administradores',
        ...
        $this->_modelName = 'Administradores';
        $this->_fieldsOnly = ['matricula', 'cargo', 'dataadmissao', 'datarecisao', 'statusadministrador', 'cpf'];
        $this->_fieldsRelated = ['pessoas'];
        ...
        $this->_col = new class()
        {
            public function __construct(
                ...
                public readonly string $statusadministrador = 'statusadministrador',
        ...
        if ($data) {
            ...
            $this->statusadministrador = $data['statusadministrador'] ?? null;
    ...
    protected function includePessoas(array $items, array $selectedFields = [], array $includeSelectedFields = [], bool $format = false) 
    {
        ...
        $tableName = ($dbType == 'pgsql' || $dbType == 'sqlite') ? "\"administradores\"" : "`administradores`";
        $tableModelName = 'Administradores';
        $tablePrimaryKey = '';
    ...
    {
        if (!isset($data['data'])) {
            throw new \Exception("The 'data' key is required when creating a new Administradores.");
        }
        ...
        foreach ($requiredFieldsMap as $fieldName => $fieldType) {
            if (!isset($data['data'][$fieldName])) {
                throw new \Exception("The '$fieldName' field of type '$fieldType' is required when creating a new Administradores.");
            }
        }
        ...
        $bindings = [];
        $dbType = $this->_dbType;
        $quotedTableName = ($dbType == 'pgsql' || $dbType == 'sqlite') ? "\"administradores\"" : "`administradores`";
                ...
                foreach ($data as $relationName => $relationDataName) {
                    ...
                    if (in_array($relationName, $relationNames)) {
                        ...
                        if (isset($relationDataName['create']) || isset($relationDataName['createMany']) || isset($relationDataName['connect']) || isset($relationDataName['connectOrCreate'])) {
                            throw new \Exception("The relation name '$relationName' is not defined in the Administradores model.");
                        }
                    }
                }
            }
    ...
    public function findUnique(array $criteria, bool $format = false): array | object
    {
        ...
        if (!$whereHasUniqueKey) {
            throw new \Exception("No valid 'where' conditions provided for finding a unique record in Administradores.");
        }
        ...
        foreach ($includes as $relation => $relationInclude) {
            if ($relationInclude) {
                ...
                if (method_exists($this, $includeMethodName)) {
                    ...
                    throw new \Exception("The '$relation' does not exist, in the Administradores model.");
                }
            }
        }
    ...
    {
        if (!isset($data['where'])) {
            throw new \Exception("The 'where' key is required in the update Administradores.");
        }
        ...
        if (!isset($data['data'])) {
            throw new \Exception("The 'data' key is required in the update Administradores.");
        }
        ...
        foreach ($requiredFieldsMap as $fieldName => $fieldType) {
            if (isset($data['data'][$fieldName]) && empty($data['data'][$fieldName])) {
                throw new \Exception("The '$fieldName' field of type '$fieldType' is required in Administradores Model.");
            }
        }
    ...
    public function delete(array $criteria, bool $format = false): array | object
    {
        ...
        try {
            ...
            return $affectedRows ? $deletedRow : ['modelName' => 'Administradores', 'cause' => 'Record to delete does not exist.'];
        } catch (\Exception $e) {
            $this->_pdo->rollBack();
            throw $e;
        }
    ...
    public function aggregate(array $operation, bool $format = false): array | object
    {
        ...
        $quotedTableName = $this->_dbType == 'pgsql' ? "\"administradores\"" : "`administradores`";
        $conditions = [];
        $bindings = [];
    ...
    {
        if (!isset($data['where'])) {
            throw new \Exception("The 'where' key is required in the updateMany Administradores.");
        }
        ...
        if (!isset($data['data'])) {
            throw new \Exception("The 'data' key is required in the updateMany Administradores.");
        }
...
";
    ...
    public function count(array $criteria = [], bool $format = false): int | array | object
    {
        ...
        $select = $criteria['select'] ?? [];
        $dbType = $this->_dbType;
        $quotedTableName = $dbType === 'pgsql' ? "\"administradores\"" : "`administradores`";
